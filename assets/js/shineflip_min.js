(function() {
	...
	function n(n) {
		this.OPEN = n.open || !0, this.FULL_SCREEN = n.autoFitScreen || !1, this.BOOK_WIDTH = n.width || 950, this.BOOK_HEIGHT = n.height || 482, this.PAGE_WIDTH = n.page_width || 475, this.PAGE_HEIGHT = n.page_height || 482, this.PAGE_IMG_URL = n.page_url || "background.jpg", this.setup()
	}
	n.prototype = {
		setup: function() {
			function wt() {
